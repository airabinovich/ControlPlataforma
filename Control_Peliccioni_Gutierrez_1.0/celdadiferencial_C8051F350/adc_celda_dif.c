...
volatile unsigned celda1 =0;
volatile unsigned celda2 =0;
volatile unsigned celda3 =0;
volatile unsigned celda4 =0;
//-----------------------------------------------------------------------------   
// Function PROTOTYPES   
//-----------------------------------------------------------------------------   
...
{   
   ...
   AD0INT = 0;   					   // AD0 INTERRUP FLAG
   ADC0MD = 0x83;                      // Start SIMPLE/CONTI conversions   
...
{   
   ...
   ADC0CLK = (24500000/MDCLK)-1;         // Generate MDCLK for modulator.   
   ...
   ADC0DAC = 0xBF;   //OFFSET POSITIVO MAXIMO
